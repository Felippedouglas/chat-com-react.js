...
const Chat = ({ user, userChat, setUserChat, setUserAudioInfo, setNewChat }) => {
  ...
  return (
    <C.Container>
      ...
      {!filesSendLength >= 1 &&
        <Body setUserAudioInfo={setUserAudioInfo} isOpenPopUpSendArchives={isOpenPopUpSendArchives} messages={messages} setMessages={setMessages} setIsOpenPopUpSendArchives={setIsOpenPopUpSendArchives} showUserDetails={showUserDetails} sendFile={sendFile} setShowUserDetails={setShowUserDetails} chatId={userChat?.chatId} userInfo={userInfo} setUserInfo={setUserInfo} setNewChat={setNewChat} setSendFile={setSendFile} showReply={showReply} setShowReply={setShowReply}
